...
class Terrain:
    ...
    def parsed(self, terrain_code : str = None) -> list :
        '''
        Returns a list of lists. Each element contains six sub elements representing ?
        ...
        '''Returns a list of lists. Each list contains six elements corresponding
        to ?.
        ...
        for string in terrain_code_split:
            ...
            # Loop over each list in new_list
        for i in range(len(new_list)):
            # Replace the first value with the associated value in the surficial_material_terms dictionary
            if new_list[i][0] in surficial_material_terms:
                new_list[i][0] = surficial_material_terms[new_list[i][0]]
            ...
            if new_list[i][3] in geomorphological_process_terms:
                new_list[i][3] = geomorphological_process_terms[new_list[i][3]]
